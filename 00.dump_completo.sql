...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `after_animales_update` AFTER UPDATE ON `animales` FOR EACH ROW BEGIN
...
--
-- Table structure for table `historico_animales`
--

DROP TABLE IF EXISTS `historico_animales`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `historico_animales` (
  `id_historico_animal` int NOT NULL AUTO_INCREMENT,
  `id_animal` int NOT NULL,
  `peso` decimal(10,2) DEFAULT NULL,
  `altura` decimal(5,2) DEFAULT NULL,
  PRIMARY KEY (`id_historico_animal`),
  KEY `fk_animales_historicos` (`id_animal`),
  CONSTRAINT `fk_animales_historicos` FOREIGN KEY (`id_animal`) REFERENCES `animales` (`id_animal`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `historico_animales`
--

LOCK TABLES `historico_animales` WRITE;
/*!40000 ALTER TABLE `historico_animales` DISABLE KEYS */;
INSERT INTO `historico_animales` VALUES (1,1,200.50,1.20);
/*!40000 ALTER TABLE `historico_animales` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `historico_personas`
--
...
CREATE TABLE `historico_personas` (
  `id_historico_persona` int NOT NULL AUTO_INCREMENT,
  `id_persona` int NOT NULL,
  `direccion` varchar(255) DEFAULT NULL,
  `telefono` varchar(20) DEFAULT NULL,
  `email` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`id_historico_persona`),
  KEY `fk_personas_historicos` (`id_persona`),
  CONSTRAINT `fk_personas_historicos` FOREIGN KEY (`id_persona`) REFERENCES `personas` (`id_persona`)
) ENGINE=InnoDB AUTO_INCREMENT=1001 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `historico_personas`
--

LOCK TABLES `historico_personas` WRITE;
/*!40000 ALTER TABLE `historico_personas` DISABLE KEYS */;
INSERT INTO `historico_personas` VALUES (1,1,'3637 Mitchell Point','7999382925','vcrosse0@amazon.co.jp');
/*!40000 ALTER TABLE `historico_personas` ENABLE KEYS */;
UNLOCK TABLES;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `after_personas_update` AFTER UPDATE ON `personas` FOR EACH ROW BEGIN
...
--
-- Dumping events for database 'reservas_naturales'
--
...
-- Dump completed on 2024-08-25 20:34:39
